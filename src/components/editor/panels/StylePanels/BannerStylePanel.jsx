// src/components/editor/panels/StylePanels/BannerStylePanel.jsx
...
const BannerStylePanel = ({ data, onChange }) => {
        ...
        <div className="collapsible-panel">
          ...
          <div className="collapsible-content">
            ...
            <div className="property-group">
              ...
              <ColorPicker
                value={data.buttonTextColor || '#202123'}
...
export default BannerStylePanel;